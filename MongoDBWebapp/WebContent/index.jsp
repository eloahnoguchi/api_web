...
<body>
    <div id="mongoDbServlet" class="container">
        <h1 align="center" class="text-primary">Faça seu Login</h1>
        <hr />
        ...
        <div id="login_form">
            <form id="user_login_form" name="loginForm" method="post" action="loginServlet">
                ...
                <div class="input-group">
                    ...
                    <input type="text" class="form-control" id="login_id" placeholder="Enter login id ..." name="login_id" maxlength="8">
                </div>
                <div>&nbsp;</div>
                <div class="input-group">
